...
export const SKILL_CATEGORIES: SkillCategory[] = [
  {
    ...
    description:
      "Defensive security blueprints, server configurations, and system hardening.",
  ...
  },
  {
    ...
    description:
      "Developing responsive and native mobile app integrations client-side.",
    badge: "Upgrade Mode",
    alienColor: "#00ffcc",
    skills: [
      "React Native",
  ...
  },
  {
    ...
    description:
      "Crafting blazing fast, responsive, and secure web applications.",
    badge: "XLR8 Mode",
    alienColor: "#a3ff12",
    skills: [
      "React.js & React 18+",
  ...
  },
  {
    ...
    description:
      "Designing, mapping, and analyzing reliable local-area and enterprise networks.",
...
export const PROJECTS: Project[] = [
  {
    ...
    description:
      "Contributed to and scaled core front-end modules within a highly secure digital banking context. Utilized TypeScript alongside React Native platforms following strict UI specifications and source control protocols.",
    points: [
  ...
  },
  {
    ...
    description:
      "Acquired depth in native mobile capabilities by producing multiple high-fidelity software clones, local storage setups, and persistent client-side data handling pipelines.",
    points: [
  ...
  },
  {
    ...
    description:
      "Conducted virtual network design maps, discovering and documenting active routes, ownership nodes, and suspicious traffic flows in real-time environments.",
    points: [
  ...
  },
  {
    ...
    period: "Exercise Run",
    description:
      "Crafted automated bash command sequences to extract critical host variables, diagnostic properties, and service alerts on Linux servers.",
    points: [
  ...
  },
  {
    ...
    description:
      "Created parsing algorithms to process standard Linux auth logs, identifying unauthorized system access, password events, and administrative escalations.",
    points: [
  ...
  },
  {
    ...
    description:
      "Maintained, designed, and tested various physical and software-simulated local networks inside standard academy laboratories.",
    points: [
...
export const BLOGS: BlogPost[] = [
  {
    ...
    snippet:
      "A deep dive into how computers negotiate local IP addresses, bridge hardware MAC footprints, and translate domain nodes across high-security corporate networks.",
  },
  {
    id: "blog2",
    title:
      "Hardening Linux Diagnostics: Developing a System Info Extractor Bash Script",
    category: "DevSecOps & Linux",
    snippet:
      "Analyzing CPU limits, tracking orphaned services, and dynamically masking private MAC addresses to preserve administrator anonymity during logging runs.",
  },
  {
    id: "blog3",
    ...
    snippet:
      "Best practices learned from building frontend banking systems using React Native and Flutter. Managing sensitive credential storage and maintaining UI fidelity.",
  },
];
...
export const CERTIFICATES: CertificateItem[] = [
  {
    ...
    downloadUrl:
      "https://vanhonghorn-portfolio-todz.vercel.app/certificate/FullCertificate.pdf",
  },
];
